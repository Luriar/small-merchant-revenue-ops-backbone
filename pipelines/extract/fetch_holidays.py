"""
Bronze extractor: Korean public holiday data.
"""
import shutil
...
def fetch(year: int, use_samples: bool = True, parent_run_id: Optional[str] = None) -> Path:
    ...
    try:
        if use_samples:
            sample_file = samples_path() / f"bronze_holidays_{year}.csv"
            ...
            raise NotImplementedError("Live data.go.kr holiday extraction not implemented in M3.")
