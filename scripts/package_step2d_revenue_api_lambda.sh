...
cp "${repo_root}/apps/api/src/revenue-ops/connector-credentials.js" "${package_root}/src/revenue-ops/connector-credentials.js"
...
cp "${repo_root}/apps/api/src/revenue-ops/connectors/delivery-provider-client.js" "${package_root}/src/revenue-ops/connectors/delivery-provider-client.js"
