...
module "revenue_api" {
  ...
  enable_lambda_versioning          = var.enable_api_lambda_versioning
  enable_lambda_alias               = var.enable_api_lambda_alias
  lambda_alias_name                 = var.api_lambda_alias_name
  lambda_alias_initial_version      = var.api_lambda_alias_initial_version
  enable_codedeploy_canary          = var.enable_api_codedeploy_canary
  codedeploy_deployment_config_name = var.api_codedeploy_deployment_config_name
